                        ...
                        <div className='my-4 flex flex-col gap-4'>
                            <div className="flex gap-3 items-center">
                                ...
                                <div>
                                    ...
                                    <span className='text-sm font-regular'>Bao Nguyen </span>
                                </div>
                            </div>
                            <div className="flex gap-3 items-center">
                                ...
                                <div>
                                    ...
                                    <span className='text-sm font-regular'>Ho Chi Minh city </span>
                                </div>
                            </div>
                            <div className="flex gap-3 items-center">
                                ...
                                <div>
                                    ...
                                    <span className='text-sm font-regular'>bao678393@gmail.com</span>
                                </div>
                            </div>
                        </div>
                    </div>
