...
import { Monitor, Code2, Code, Palette } from "lucide-react";
...
const itemsList = [
    <div className="card group" onDragStart={handleDragStart} role="presentation" key={uuid()}>
        <Monitor size={50} color='#8490FF' className='group-hover:stroke-white' />
        <h3>Web Design</h3>
        <p>“I create clean, modern, and responsive web designs focused on user experience.</p>
    </div>,
    <div className="card group" onDragStart={handleDragStart} role="presentation" key={uuid()}>
        <Code2 size={50} color='#8490FF' className='group-hover:stroke-white' />
        <h3>Frontend Developer</h3>
        <p>“Frontend Developer crafting fast, responsive, and user-focused web experiences.</p>
    </div>,
    <div className="card group" onDragStart={handleDragStart} role="presentation" key={uuid()}>
        <Code size={50} color='#8490FF' className='group-hover:stroke-white' />
        <h3>UI Design</h3>
        <p>UI Designer creating clean, intuitive, and visually engaging interfaces.</p>
    </div>,
    <div className="card group" onDragStart={handleDragStart} role="presentation" key={uuid()}>
        <Palette size={50} color='#8490FF' className='group-hover:stroke-white' />
        <h3>Software Developer</h3>
        <p>Software Developer building reliable, scalable, and high-performance applications.</p>
    </div>,
